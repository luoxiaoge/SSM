...
*
    ...
    private void ensureCapacityInternal(int minCapacity) {
        //如果该数组是原始数组 取出默认长度，和预定长度比较取最大的哪一个
...
*
     * Appends the specified element to the end of this list.（在链表尾部添加指定元素）
     *
     * @param e element to be appended to this list  即将添加的元素
     * @return <tt>true</tt> (as specified by {@link Collection#add})  添加成功返回true
